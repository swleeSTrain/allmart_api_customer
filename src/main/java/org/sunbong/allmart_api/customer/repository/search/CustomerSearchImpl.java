    ...
    public CustomerResponseDTO findByPhoneNumberOrEmail(String customerData, CustomerLoginType loginType) {
        ...
        if (customerData != null) {
            if (loginType == CustomerLoginType.PHONE) {
                builder.and(customer.phoneNumber.eq(customerData));
            } else if (loginType == CustomerLoginType.SOCIAL) {
                builder.and(customer.email.eq(customerData));
            }
        }
...
//                .fetchOne();
        ...
        return (loginType == CustomerLoginType.SOCIAL) ? CustomerResponseDTO.builder()
                .email(customerData)
                .build()
